    ...
    return (
      <div className="row mb-3">
        <div className="col-1">
          <div className="d-flex justify-content-center">
            <i
              className={`bi ${isAvailable ? "bi-car-front-fill text-success" : "bi-car-front text-muted"} fs-5`}
            ></i>
          </div>
        </div>
        <div className="col-11">
          ...
          <span
            className={`badge ${isAvailable ? "bg-success" : "bg-secondary"} rounded-pill px-3 py-2`}
          >
    ...
    <div className="card border-0 shadow h-100">
      ...
      <div className="card-body p-4">
        <InfoItem
          ...
          label="주소"
          value={facility.roadAddress || facility.jibunAddress}
        />
